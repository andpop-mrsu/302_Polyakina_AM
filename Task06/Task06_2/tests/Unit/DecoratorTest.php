...
namespace Polyakinaam\Tests;

use PHPUnit\Framework\TestCase;
use Polyakinaam\Task062\EconomyRoom;
use Polyakinaam\Task06_2\StandardRoom;
use Polyakinaam\Task06_2\SuiteRoom;
use Polyakinaam\Task06_2\InternetDecorator;
use Polyakinaam\Task06_2\BreakfastDecorator;
use Polyakinaam\Task06_2\FoodDeliveryDecorator;
use Polyakinaam\Task06_2\SofaDecorator;
